            ...
            <div className='flex flex-col gap-6 p-8 w-full'>
                <div className='relative'>
                    ...
                    <Input
                        ...
                        className='pl-10 focus-visible:ring-transparent h-12 text-base'
                    />
                </div>
                ...
                {!loading && searchQuery.trim() === '' && searchResults.length === 0 && (
                    <div className='text-center py-12'>
                        <SearchIcon className='mx-auto text-gray-300 w-16 h-16 mb-4' />
                        <p className='text-gray-500 text-lg'>No users found</p>
                    </div>
                )}
                ...
                {!loading && searchResults.length > 0 && (
                    <div className='flex flex-col gap-3'>
                        ...
                        {searchResults.map((user) => {
                            ...
                            return (
                                <div key={user._id} className='flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors duration-200 shadow-sm hover:shadow-md'>
                                    <div className='flex items-center gap-3 flex-1'>
                                        ...
                                        <div className='flex-1 min-w-0'>
                                            <Link to={`/profile/${user._id}`}>
                                                <h3 className='font-semibold hover:underline text-base'>{user?.username}</h3>
                                            </Link>
                                    ...
                                    {user._id !== currentUser?._id && (
                                        <button
                                            ...
                                            className={`px-5 py-2 rounded-lg font-medium transition-all duration-200 flex-shrink-0 ${
                                                isFollowing
